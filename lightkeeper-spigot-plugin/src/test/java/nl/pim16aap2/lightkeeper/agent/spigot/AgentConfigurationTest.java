...
class AgentConfigurationTest
{
    ...
    void fromSystemProperties_shouldReadRequiredValues()
    {
        ...
        withProperties(Map.of(
            ...
            RuntimeProtocol.PROPERTY_PROTOCOL_VERSION, "1",
        ...
        ), () ->
        {
            ...
            assertThat(configuration.protocolVersion()).isEqualTo(1);
        ...
        throws Exception
    {
        ...
        // execute + verify
        assertThatThrownBy(() -> constructor.newInstance(null, "token", 1, ""))
    ...
    @Test
    void fromSystemProperties_shouldThrowExceptionWhenProtocolVersionIsNotAnInteger()
    {
        // setup
        withProperties(Map.of(
            RuntimeProtocol.PROPERTY_SOCKET_PATH, "agent.sock",
