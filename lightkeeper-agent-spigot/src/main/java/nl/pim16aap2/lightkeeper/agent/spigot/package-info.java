 ...
 *
 * <p>This package hosts the complete Paper/Spigot integration for remote-driven integration tests.
 ...
 *
 * <p><strong>Primary goal</strong>: provide a stable automation surface for LightKeeper runtime tests so test
 * infrastructure can create worlds, spawn synthetic players, execute commands, inspect game state, and interact with
 * inventories without relying on in-process test hooks.
 *
 ...
 *   <li>{@link nl.pim16aap2.lightkeeper.agent.spigot.AgentMenuController} defines canonical built-in test menus
 *       and click semantics used by menu actions.</li>
 * </ul>
 *
